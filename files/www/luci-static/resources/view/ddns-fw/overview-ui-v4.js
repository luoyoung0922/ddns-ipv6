  ...
  render: function(s) {
    ...
    var view = E("div", { "class": "ddns-fw-dashboard" }, [
      ...
      E("div", { "class": "ddns-fw-hero" }, [
        E("div", { "class": "ddns-fw-hero-main" }, [
          ...
          E("div", { "class": "ddns-fw-actions" }, [
            E("span", { "class": "ddns-fw-pill" }, "● " + (masterEnabled && s.service === "running" ? "运行中" : "已关闭")),
            E("span", { "class": "ddns-fw-pill" }, "后端 " + text(s.backend)),
            E("button", { "class": "cbi-button cbi-button-action ddns-fw-refresh", "disabled": !masterEnabled, "click": ui.createHandlerFn(self, function() {
      ...
      E("div", { "class": "ddns-fw-grid" }, [
        ...
        E("div", { "class": "ddns-fw-card" }, [E("span", { "class": "ddns-fw-muted" }, "Webhook"), E("strong", {}, masterEnabled && s.api_running ? ":" + text(s.api_port) : "已关闭")]),
      ...
      E("div", { "class": "ddns-fw-panel" }, [E("div", { "class": "ddns-fw-panel-head" }, [E("h3", {}, "运行提示"), E("span", {}, masterEnabled ? "自动同步已开启" : "插件已完全关闭")]), E("div", { "class": "ddns-fw-hint" }, masterEnabled ? "主动模式会轮询 NDP / DHCPv6；Webhook 使用 Authorization: Bearer Token。地址变化走 nft 原子热更新，只有规则拓扑变化才会 reload 防火墙。" : "后台监听、Webhook 和动态防火墙规则均已停止；你的规则配置仍被保留，重新开启后会自动恢复。")])
    ]);
